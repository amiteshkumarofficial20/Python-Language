...
# you can always extend the game and make it more interesting!
#used ascii art in gooogle to make this treasure island!
# ''' becaus to print multi line string we used ''' ''' '''
# \ used as escape symbol in programming
