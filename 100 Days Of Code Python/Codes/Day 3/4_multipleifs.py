...
# because if/elif/else are mutually exclusive. The first condition
# has to fail to go into the elif and the elif (or multiple elif) 
# have to fail to go into the else. Condition 2 is only checked 
